...
//		좋아요
		...
		void contractionPrint() {
			System.out.println("게시물 구분자 : " + id + " / 게시물 제목 : " + title + " / 게시물 작성자 : " + writer);
		}
...
public class Sample01 {
	...
	//Board[] BOARD_LIST = new Board[3]; : 인스턴스 상태
...
//				System.out.println(board);
			...
			// 수정이 완료되면 처음화면으로 돌아가게 하기(while문 없이)
...
//			게시물 작성을 선택하면 타이틀, 작성자, 작성날짜 및 시간, 내용을 입력할 수 있음	
...
//			처음 화면일 시 종료를 선택하면 프로그램이 3)종료됨
			if (mainSelectNumber == 0) {
				System.out.println("프로그램 종료");
				// 1. while 문의 조건을 false로
				power = false;
				// 2. break 문으로 while 문을 강제 종료
				// break;
				// 3. return 문으로 main 메소드를 종료
				// return;
				}
