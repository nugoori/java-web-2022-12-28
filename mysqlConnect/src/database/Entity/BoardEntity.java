...
// 목적 : 데이터베이스 테이블 각각의 레코드를 인스턴스로 받기 위한 용도
// 조건 : 데이터베이스 테이블의 각 컬럼명, 데이터 타입과 Entity class의 필드명, 데이터타입이 일치해야 함
...
public class BoardEntity {
	...
	public BoardEntity
	(Integer id, String boardTitle, String boardContent, String boardDateTime, Integer boardLike,Integer boardWriter) {
		this.id = id;
